...
Base URL: https://scenario-analyzer.preview.emergentagent.com
"""
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://scenario-analyzer.preview.emergentagent.com').rstrip('/')
