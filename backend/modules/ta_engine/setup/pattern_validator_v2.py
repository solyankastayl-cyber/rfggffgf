...
class PatternValidatorV2:
    ...
    def find_best_line(
        ...
        """
        Find best-fit trendline with all P0 fixes applied.
        """
        if len(pivots) < 2:
            return None
        ...
        for line in candidates:
            ...
            score, violations = self.score_trendline(line, pivots, candles, line_type, pattern_start)
            
            # P0.4 FIX: Hard filter - отбрасываем линию с слишком большим кол-вом violations
